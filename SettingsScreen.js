...
export default function ProfileScreen({ navigation }) {
  ...
  const handleSaveChanges = async () => {
    try {
      // Mise à jour de l'email et du mot de passe localement
      if (email) {
        await AsyncStorage.setItem("userEmail", email);
      }

      if (password) {
        // Vous pouvez ajouter la logique pour enregistrer le mot de passe si nécessaire
